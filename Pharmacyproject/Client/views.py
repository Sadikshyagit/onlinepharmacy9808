...
class CheckoutView(EcomMixin, CreateView):
    ...
    def dispatch(self, request, *args, **kwargs):
        if not request.user.is_authenticated or not request.user.customer:
...
class KhaltiVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        headers = {
            "Authorization": "Key test_secret_key_1c2124dd2b9a45388d41835e498c43d9"
        }
...
class SearchView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        results = Product.objects.filter(
            Q(title__icontains=kw) | Q(description__icontains=kw) | Q(manufacture_date__icontains=kw))
        print(results)
